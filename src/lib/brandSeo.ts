...
export const HOME_TITLE =
  "Buy Premium Sarees & Salwar Suits Online in India | The House of Rani";
...
export const ORG_SCHEMA_DESCRIPTION =
  "Premium sarees, salwar suits, and Indian ethnic wear curated for weddings, festivities, and timeless everyday elegance. Pan-India delivery from The House of Rani.";

export const HOME_OG_TITLE =
  "Premium Sarees, Salwar Suits & Indian Ethnic Wear | The House of Rani";

export const HOME_OG_DESCRIPTION =
  "Discover exquisite sarees, salwar suits, and ethnic wear — heritage craftsmanship with modern elegance. Free delivery over ₹1,099.";
...
export const SHOP_META_TITLE = "Shop Sarees, Salwar Suits & Ethnic Wear Online India";
export const SHOP_META_DESCRIPTION =
  "Shop premium sarees, salwar suits, lehengas, and ethnic wear at The House of Rani. Filter by category, fabric, price, and rating. Free delivery over ₹1,099.";
