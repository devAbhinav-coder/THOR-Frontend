...
const InventoryLedgerTab = lazy(
  () => import("./components/InventoryLedgerTab"),
);
const PurchaseInvoicesTab = lazy(
  () => import("./components/PurchaseInvoicesTab"),
);
...
const TABS = [
  {
    ...
    label: "Stock & Margin",
    icon: Warehouse,
    desc: "Stock, units sold, estimated revenue & gross margin per SKU",
  },
  {
    id: "ledger",
    label: "Movement Log",
    icon: History,
    desc: "Audit trail - sales, purchases, returns & adjustments",
  },
  {
    id: "purchase",
    label: "Purchase Bills",
    icon: FileText,
    desc: "Supplier tax invoices (CGST/SGST/IGST) - view, edit & void",
  },
  {
    id: "gst",
    label: "GST / GSTR-2",
    icon: Receipt,
    desc: "Input tax credit summary by supplier & month (purchase register)",
  },
] as const;
