    ...
    <div className='p-4 sm:p-6 xl:p-8 space-y-5'>
      <div className='bg-gradient-to-r from-navy-900 to-brand-700 rounded-2xl p-5 text-white'>
        ...
        <p className='text-sm text-white/80 mt-1 max-w-2xl'>
          Buy 1 Get 1, Buy 2 Get ₹200 off, and more - no coupon code needed.
          Offers apply automatically when matching items are in the cart. Scope
          by subcategory, category, or product.
        </p>
      </div>
        ...
        : promotions.length === 0 ?
          <div className='p-12 text-center'>
            ...
            <p className='text-sm text-gray-400 mt-1'>
              Create Buy 1 Get 1 or quantity discounts that apply in cart
              automatically.
            </p>
          </div>
              ...
              <tbody className='divide-y divide-gray-50'>
                {promotions.map((p) => (
                  <tr key={p._id} className='hover:bg-gray-50/80'>
                    ...
                    <td className='px-5 py-3.5'>{lifecycleBadge(p)}</td>
