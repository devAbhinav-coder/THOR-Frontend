      ...
      queryClient.setQueriesData(
        ...
        (old: unknown) => {
          ...
          const pages = typed.pages.map((page) => {
            const idx = page.products.findIndex(
                      ...
                      return (
                        ...
                        >
                          <td className='px-5 py-3'>
                            <div className='flex items-center gap-3'>
                              ...
                              <div className='min-w-0'>
                                <p className='text-sm font-bold text-gray-900 truncate max-w-[200px] group-hover:text-brand-700 transition-colors'>
                                  {product.name}
                                </p>
                          ...
                          <td className='px-4 py-3'>
                            <div>
                              <span
                                className={`text-sm font-bold ${stockClass(sm.total)}`}
                              >
                                {sm.total === 0 ?
                                  "Out of stock"
                                : `${sm.total} in stock`}
                              ...
                              {sm.breakdown && (
                                <p
                                  className='text-[10px] font-semibold text-gray-500 mt-0.5 max-w-[140px]'
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className='p-3'>
                        ...
                        <p
                          className={`text-xs font-semibold mt-1.5 ${stockClass(sm.total)}`}
                        >
                          {sm.total === 0 ?
                            "Out of stock"
                          : `${sm.total} in stock`}
                        ...
                        <div className='mt-2.5 pt-2.5 border-t border-gray-100 flex items-center justify-between text-xs font-medium text-gray-500'>
                          ...
                          <span className='text-navy-700 bg-navy-50 px-2.5 py-0.5 rounded-full'>
                            {product.soldCount || 0} sold
                          </span>
                        </div>
                        ...
                        <div className='flex-1 min-w-0'>
                          ...
                          <div className='mt-2 space-y-0.5'>
                            ...
                            <div className='flex items-center gap-2 flex-wrap pt-1'>
                              ...
                              <span
                                className={`text-xs font-semibold ${stockClass(sm.total)}`}
                              >
                                {sm.total === 0 ?
                                  "Out of stock"
                                : `${sm.total} in stock`}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className='p-2.5'>
                        ...
                        <p
                          className={`mt-1 text-[10px] font-semibold ${stockClass(sm.total)}`}
                        >
                          {sm.total === 0 ?
                            "Out of stock"
                          : `${sm.total} in stock`}
        ...
        <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/50'>
          <div className='bg-white rounded-xl p-6 max-w-sm mx-4 text-center space-y-4'>
            ...
            <p className='text-sm text-gray-500'>
              This action cannot be undone. All images will be removed from
              Cloudinary.
            </p>
