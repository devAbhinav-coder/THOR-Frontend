      ...
      {!loading && status && !status.configured && (
        <div className='rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 flex gap-3 text-sm text-amber-900'>
          ...
          <p>
            ...
            on the server. Templates must be approved in Meta WhatsApp Manager.
          </p>
        </div>
      )}
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-3'>
          {[
            ...
            },
            {
              ...
              sub:
                status.queue ?
                  `${status.queue.failed} failed jobs`
                : "No Redis queue",
              tone: "text-navy-800",
              icon: Clock,
            },
        ...
        <div className='xl:col-span-3 space-y-5'>
          <div className='bg-white rounded-2xl border border-gray-100 p-5'>
            ...
            <p className='text-sm text-gray-500 mb-4'>
              These send automatically - like email. Create matching templates
              in Meta WhatsApp Manager with the env names below.
            </p>
          ...
          <div className='bg-white rounded-2xl border border-gray-100 p-5'>
            ...
            {status && (
              <p className='text-[11px] text-gray-400 mt-4 pt-3 border-t border-gray-100'>
                ...
                {status.stats.allTime.failed.toLocaleString()} failed ·
                Templates {configuredTemplates}/{totalTemplates} configured
              </p>
            )}
          </div>
        </div>
        ...
        <div className='xl:col-span-2 space-y-5'>
          ...
          <div className='rounded-2xl border border-emerald-100 bg-emerald-50/50 p-5 text-sm text-emerald-900 space-y-2'>
            ...
            <p className='text-xs leading-relaxed text-emerald-800/90'>
              ...
              and enable the <strong>WhatsApp</strong> channel. Uses the catalog
              template with your subject + link - same audience as email
              (opted-in users with phone).
            </p>
            <p className='text-xs leading-relaxed text-emerald-800/90'>
              Review invites: use the WhatsApp button on any order&apos;s review
              QR panel.
            </p>
          </div>
        </div>
