    ...
    <div className='p-4 sm:p-6 xl:p-8 space-y-5'>
      <div className='bg-gradient-to-r from-navy-900 to-brand-700 rounded-2xl p-5 text-white'>
        ...
        <p className='text-sm text-white/80 mt-1'>
          Put categories or products on sale - prices update on shop and PDP
          while live. Optional popup image shows on store visits. Use QR / link
          to send customers to the shop.
        </p>
