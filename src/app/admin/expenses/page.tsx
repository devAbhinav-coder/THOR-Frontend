...
import ExpenseHeatmap, {
  type HeatmapCell,
} from "@/components/admin/expenses/ExpenseHeatmap";
import {
  EXPENSE_CATEGORIES,
  categoryLabel,
  categoryColor,
      ...
      <div className='bg-white rounded-2xl shadow-xl w-full max-w-lg my-8'>
        <div className='flex items-center justify-between px-6 py-4 border-b'>
          <h3 className='font-bold text-gray-900'>
            {initial ? "Edit expense" : "Add operating cost"}
          </h3>
          <button
            type='button'
            onClick={onClose}
  ...
  return (
    <div className='p-4 sm:p-6 xl:p-8 max-w-[1600px] mx-auto space-y-6'>
      <AdminPageHeader
        ...
        badge='Expenses'
        description='All expenses related to the business.'
        actions={
          <>
            <Button
              variant='outline'
            ...
            {[
              {
                ...
                value: formatPrice(summary.yearTotal),
                sub: "All categories",
              },
              {
                label: "This month (MTD)",
                value: formatPrice(summary.monthToDateTotal),
                sub: "Current month",
              },
              {
                label: "All-time logged",
                value: formatPrice(summary.allTimeTotal),
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 gap-2'>
              {summary.byCategory.map((row) => {
                ...
                return (
                  <div
                    key={row.category}
                    className='rounded-xl border border-gray-100 bg-white p-3 flex gap-2'
                  >
                    <div
                      className={cn(
              ...
              : expenses.map((e) => (
                  <tr key={e._id} className='hover:bg-gray-50/80'>
                    ...
                    <td className='px-4 py-3'>
                      ...
                      {e.notes && (
                        <p className='text-[10px] text-gray-400 truncate max-w-[240px]'>
                          {e.notes}
                        </p>
                      )}
                    </td>
