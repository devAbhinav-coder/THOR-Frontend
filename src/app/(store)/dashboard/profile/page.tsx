    ...
    <div className='flex flex-col gap-account-stack-lg pb-6'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-12 gap-account-gutter'>
        ...
        <section className='lg:col-span-8 flex flex-col gap-6'>
          <div>
            <h2 className='font-serif text-2xl md:text-3xl text-account-primary'>
              Personal Information
            </h2>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-8'>
              ...
              <div className='space-y-2'>
                ...
                <div className='flex items-center gap-2 border-b border-account-outline-variant/50 pb-2'>
                  <span className='text-account-primary text-base truncate flex-1'>
                    {user?.email}
                  </span>
                  {user?.emailVerified && (
                    <BadgeCheck
                      className='h-5 w-5 text-account-secondary shrink-0'
                      aria-label='Verified email'
                    />
                  )}
                </div>
                <p className='text-[10px] uppercase tracking-wider text-account-outline'>
