  ...
  const onSubmit = async (data: AddressForm) => {
    ...
    try {
      const normalizedPhone =
        parsePhoneNumberFromString(data.phone.replace(/\s+/g, ""), "IN")
          ?.number || data.phone;
    ...
    <div className='flex flex-col gap-account-stack-lg pb-6'>
      <header className='flex flex-col sm:flex-row sm:items-end justify-between gap-4'>
        <div>
          ...
          <p className='text-sm text-account-on-surface-variant mt-2 max-w-xl'>
            Manage your preferred delivery destinations for your bespoke
            collections and seasonal pieces.
          </p>
        </div>
        {!isAdding && (
          <button
      ...
      {user?.addresses.length === 0 && !isAdding && (
        <div className='bg-account-surface-container-lowest border border-account-outline-variant/30 p-12 text-center'>
          ...
          <p className='text-account-on-surface-variant'>
              ...
              >
                <div className='flex items-start justify-between gap-3 mb-4'>
                  <div className='flex items-center gap-2 min-w-0'>
                    ...
                    <h3 className='font-serif text-lg text-account-primary truncate'>
                      {addr.name}
                    </h3>
                  </div>
                  {addr.isDefault && (
                ...
                <p className='text-sm text-account-primary font-medium mb-6'>
                  {addr.phone}
                </p>
        ...
        <section className='bg-account-surface-container-lowest border border-account-outline-variant/30 p-6 md:p-8'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-8'>
            ...
            <label className='flex items-center gap-3 cursor-pointer'>
              ...
              />
              <span className='text-sm text-account-on-surface-variant'>
