...
function ReviewInviteForm() {
  ...
  const selected =
    invite?.items.find((i) => i.productId === selectedId) || null;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const remaining = Number(
        (res.data as { remainingCount?: number })?.remainingCount ?? 0,
      );
      ...
      <div className='min-h-[70vh] flex items-center justify-center px-4 py-16 bg-[#faf8f5]'>
        <div className='max-w-md w-full text-center rounded-2xl bg-white border border-navy-900/8 p-8 shadow-sm'>
          ...
          <p className='mt-2 text-sm text-gray-500 leading-relaxed'>
            Your review and story were received. We'll approve them before they
            go live.
          </p>
        </div>
      </div>
      ...
      <div className='mx-auto max-w-lg'>
        <div className='text-center'>
          ...
          <p className='mt-3 text-sm text-gray-500 leading-relaxed'>
            ...
            - add your words and a photo. We approve before anything goes live.
          </p>
        </div>
