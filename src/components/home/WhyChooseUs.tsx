...
const features = [
  {
    ...
    description: "Handpicked gifts curated for every special moment",
  },
  {
    icon: ShieldCheck,
    title: "Authentic Ethnic Wear",
    description: "Premium sarees crafted with tradition and elegance",
  },
  {
    icon: Truck,
    title: "Free Shipping",
  ...
  },
  {
    ...
    description: "Carefully curated fabrics with strict quality checks",
  },
];
    ...
    <section className='py-20 bg-navy-900'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-14'>
          <p className='text-brand-400 font-medium uppercase tracking-widest text-xs mb-3'>
            Why Shop With Us
          </p>
