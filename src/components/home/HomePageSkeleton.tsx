    ...
    <section className='bg-white'>
      ...
      <div className='flex gap-3 overflow-hidden px-4 pb-1 md:hidden'>
        {Array.from({ length: 3 }).map((_, i) => (
          <div
            key={i}
            className='w-[78vw] shrink-0 border border-[#c5a059]/30 bg-white p-2 sm:w-[300px]'
          >
      ...
      <div className='mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-12 lg:px-8 lg:py-14'>
        ...
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5'>
          {Array.from({ length: 3 }).map((_, i) => (
            <div
              key={i}
              className='border border-[#c5a059]/30 bg-white px-6 py-6 sm:px-7 sm:py-7'
            >
        ...
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
          ...
          <div className='flex gap-3 overflow-hidden pb-1 sm:gap-4 lg:gap-5'>
            {Array.from({ length: 4 }).map((_, i) => (
              <div
                key={i}
                className='w-[calc(50%-0.375rem)] shrink-0 sm:w-[calc(50%-0.5rem)] lg:w-[calc(25%-0.9375rem)] flex h-full flex-col border-[3px] border-white bg-white'
              >
