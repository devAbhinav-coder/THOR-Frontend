            ...
            <div className='flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8'>
              <div className='max-w-xl'>
                ...
                <p className='mt-3 text-stone-600 text-sm sm:text-base leading-relaxed'>
                  Quick paths across our store - shop, collections, policies,
                  and styling - so you never lose the thread.
                </p>
              </div>
              <Link
                href='/shop/collections'
                className={aboutPageStyles.ctaOutlineNavy}
              >
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        featured &&
          "sm:min-h-[140px] border-navy-900 bg-navy-900 text-white hover:border-navy-800",
      )}
    >
      <span
        className={cn(
        ...
        <div>
          <span
            className={cn(
              ...
              featured ? "text-white" : (
                "text-navy-900 group-hover:text-brand-600 transition-colors"
              ),
            )}
          >
            {link.label}
