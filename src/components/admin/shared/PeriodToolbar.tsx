...
const PERIODS: { id: RevenuePeriod; label: string; hint: string }[] = [
  { id: 'month', label: 'This month', hint: 'MTD in IST (orders)' },
  { id: 'year', label: 'Year', hint: 'Calendar year (orders)' },
  { id: 'lifetime', label: 'Lifetime', hint: 'Catalog soldCount' },
];
...
export default function PeriodToolbar({
  ...
  return (
    <div
      className={cn(
        'rounded-xl border border-gray-200/80 bg-white px-4 py-3 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3',
        className,
      )}
    >
