...
export default function SaleCampaignFormModal({
  campaign,
  onClose,
  onSave,
}: Props) {
  ...
  const [formData, setFormData] = useState({
    ...
    endDate:
      campaign ? new Date(campaign.endDate).toISOString().slice(0, 16) : "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        formData.maxDiscountPerItem
      ) {
        fd.append(
          "maxDiscountPerItem",
          String(Number(formData.maxDiscountPerItem)),
        );
      }
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className='space-y-4'>
        ...
        <AdminOfferSection
          title='Sale details'
          description='Name, badge & discount'
          icon={Percent}
        >
            ...
            {formData.discountType === "percentage" ?
              <Input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    maxDiscountPerItem: e.target.value,
                  })
                }
              />
            : null}
          ...
          {formData.discountType === "fixed" ?
            <AdminOfferInfoBox tone='blue'>
              Products in this sale will sell at this price (e.g. ₹1150) when
              MRP is higher.
            </AdminOfferInfoBox>
          : null}
        </AdminOfferSection>
        ...
        <AdminOfferSection
          title='Schedule'
          description='When the sale is live'
          icon={Calendar}
        >
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
        ...
        <AdminOfferSection
          title='Apply sale to'
          description='Which products get the discount'
          icon={ShoppingBag}
        >
          <PromoScopePicker
            scopeType={formData.scopeType}
        ...
        >
          ...
          <div className='space-y-3 pt-1'>
            <AdminOfferSwitch
              ...
              onChange={(v) =>
                setFormData({ ...formData, showOnStorefront: v })
              }
