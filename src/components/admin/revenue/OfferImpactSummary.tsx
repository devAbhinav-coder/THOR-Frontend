    ...
    <section className='rounded-[1.5rem] border border-gray-200/80 bg-white p-5 sm:p-6 shadow-sm space-y-4'>
      <div>
        <h3 className='text-sm font-bold text-gray-900'>
          Offer impact - sales · auto · coupons · popup
        </h3>
        <p className='text-xs text-gray-500 mt-1'>
          {periodLabel ?? "Selected period"} - all merchandising systems, not
          popup alone. Sale savings are already in product line prices; auto
          offers &amp; coupons reduce checkout total.
        </p>
      </div>
      ...
      {!hasAny ?
        <p className='text-xs text-gray-400 border-t border-gray-100 pt-3'>
          No offer data yet for this period. Place a test order with a sale,
          auto offer, or coupon - new orders store the full breakdown.
        </p>
      : null}
    </section>
  );
