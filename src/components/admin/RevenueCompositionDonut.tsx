 ...
 */
export default function RevenueCompositionDonut({
  gross,
  refunded,
  netLike,
  className,
  ...
  const dim =
    size === "lg" ? "h-[min(280px,72vw)] w-[min(280px,72vw)]" : "h-48 w-48";
        ...
        >
          ...
          >
            ...
            <p className='text-sm text-gray-500 mt-1'>
              When orders pay, this ring fills in.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className={cn("flex flex-col items-center", className)}>
      <div className={cn("relative mx-auto", dim)}>
        <div
          className='h-full w-full rounded-full shadow-[0_12px_40px_-12px_rgba(15,23,42,0.25)]'
        ...
        >
          ...
          <p className='text-lg sm:text-2xl font-bold text-gray-900 tabular-nums tracking-tight mt-0.5'>
            {formatPrice(net)}
          </p>
      ...
      <div className='mt-5 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm'>
        <div className='flex items-center gap-2'>
          <span
            className='h-2.5 w-2.5 rounded-full bg-emerald-600 shadow-sm'
            aria-hidden
          />
        ...
        <div className='flex items-center gap-2'>
          <span
            className='h-2.5 w-2.5 rounded-full bg-amber-500 shadow-sm'
            aria-hidden
          />
          <span className='text-gray-600'>
            Refunded{" "}
        ...
        <div className='flex items-center gap-2'>
          ...
          <span className='text-gray-500 text-xs'>
            Ring = 100% of gross ({formatPrice(g)})
          </span>
        </div>
      </div>
    </div>
