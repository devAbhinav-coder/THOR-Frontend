...
export default function MarketingPulseStrip({ topViewed }: MarketingPulseStripProps) {
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-white/50 mt-0.5">
              Most viewed products — use for campaigns, restocks, and homepage featuring
            </p>
          </div>
        </div>
        <Link
          href="/admin/analytics#storefront-demand"
          className="inline-flex items-center gap-1.5 rounded-lg bg-gold-400/20 border border-gold-400/30 px-3 py-2 text-xs font-bold text-gold-200 hover:bg-gold-400/30 hover:text-white shrink-0 transition-colors"
        >
          Open traffic hub
