...
export default function BlogImageGalleryEditor({
  ...
  const updateRow = (index: number, patch: Partial<GalleryRow>) => {
    onRowsChange(
      rows.map((row, i) =>
        i === index ? ({ ...row, ...patch } as GalleryRow) : row,
      ),
    );
  };
          ...
          return (
            <div
              ...
              className={`flex gap-3 p-3 rounded-xl border bg-white transition-all ${
                isDragging ?
                  "opacity-50 border-brand-400 scale-[0.98]"
                : "border-gray-200"
            ...
            >
              ...
              <div className='flex-1 min-w-0 space-y-2'>
                ...
                <div className='flex flex-wrap gap-1.5'>
                  ...
                  <button
                    ...
                    onClick={() =>
                      updateRow(index, {
                        placement:
                          row.placement === "gallery" ? "article" : "gallery",
                      })
                    }
                ...
                <input
                  ...
                  value={row.caption}
                  onChange={(e) =>
                    updateRow(index, { caption: e.target.value })
                  }
                ...
                {row.layout === "split" && (
                  <p className='text-[10px] text-violet-700 leading-snug'>
                    Split: add caption here for text panel, or pair with another
                    image in the Media panel above.
                  </p>
                )}
