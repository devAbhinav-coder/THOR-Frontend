        ...
        >
          <div className='bg-gradient-to-r from-navy-900 via-navy-800 to-navy-900 text-white px-4 py-3.5 shrink-0'>
            <div className='flex items-start justify-between gap-3'>
              <div>
                <p className='text-[11px] uppercase tracking-widest text-gold-300 font-semibold'>
                  Customer support
                </p>
                ...
                <p className='text-xs text-white/75 mt-0.5'>
                  Hi there - order, delivery, and account help
                </p>
              </div>
              <button
              ...
              {messages.length === 0 && (
                <div className='rounded-2xl border border-dashed border-gray-300 bg-white/90 px-4 py-5 text-center'>
                  ...
                  <p className='mt-1 text-xs text-gray-500'>
                    Just say “Hey” and tell us what you need.
                  </p>
                            ...
                            >
                              ...
                              <div className='mt-2 flex flex-wrap gap-1.5'>
                                <button
                                  type='button'
                                  onClick={() =>
                                    void handleAction(`order_pick:${o.id}`)
                                  }
                                ...
                                {o.canCancel ?
                                  <button
                                    type='button'
                                    onClick={() =>
                                      void handleAction(`cancel_ask:${o.id}`)
                                    }
